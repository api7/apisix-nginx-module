...
#if (NGX_DARWIN)
int
ngx_meta_lua_ffi_shdict_get_macos(ngx_meta_lua_shdict_get_params_t *p)
{
    return ngx_meta_lua_ffi_shdict_get(p->zone, p->key, p->key_len,
...
int
ngx_meta_lua_ffi_shdict_store_macos(ngx_meta_lua_shdict_store_params_t *p)
{
    return ngx_meta_lua_ffi_shdict_store(p->zone, p->op, p->key, p->key_len,
                                           p->value_type, p->str_value_buf,
                                           p->str_value_len, p->num_value,
...
int
ngx_meta_lua_ffi_shdict_incr_macos(ngx_meta_lua_shdict_incr_params_t *p)
{
    return ngx_meta_lua_ffi_shdict_incr(p->zone, p->key, p->key_len,
